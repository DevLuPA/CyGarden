...
class Transmitter {
public:
    Transmitter(): rf_driver(2000, 21, 22) {}
    void initialize() {
    if (!rf_driver.init()) {
...
const char* ssid = "NoPassaran";
const char* password = "315281315281";
...
void sendBy433(){
  ...
  // emmit data by 433
 // tx.sendData(PARAM_STRING);
 transmitter.sendMessage(PARAM_STRING);
}
